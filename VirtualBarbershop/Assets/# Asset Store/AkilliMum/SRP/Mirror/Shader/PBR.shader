Shader "AkilliMum/URP/Mirrors/PBR"
{
    Properties 
    {
        ...
        _Blend("__blend", Float) = 0.0 //it is __mode on ComplexLit
        _Cull("__cull", Float) = 2.0
        [ToggleUI] _AlphaClip("__clip", Float) = 0.0
        //[HideInInspector] _BlendOp("__blendop", Float) = 0.0 //exists only in ComplexLit
        ...
        [HideInInspector]_CustomBrightnessIntensity("_CustomBrightnessIntensity", Range(0.0, 10.0)) = 1.
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include_with_pragmas "../../Pipeline/Core/ShaderLibrary/FoveatedRenderingKeywords.hlsl"
            ...
            #include_with_pragmas "../../Pipeline/ShaderLibrary/ProbeVolumeVariants.hlsl"
        ...
        Pass
        {
            ...
            #include "../../Pipeline/Shaders/LitInput.hlsl"
            #include_with_pragmas "../../Pipeline/ShaderLibrary/ObjectMotionVectors.hlsl"
            ENDHLSL
        }
