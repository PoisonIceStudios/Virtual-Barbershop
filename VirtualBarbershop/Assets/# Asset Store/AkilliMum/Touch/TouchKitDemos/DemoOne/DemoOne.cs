...
namespace AkilliMum.Touches
{
    public class DemoOne : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            GUILayout.BeginArea(new Rect(Screen.width - GUI.skin.button.fixedWidth - 20, 0,
                GUI.skin.button.fixedWidth + 20, Screen.height));
            _scrollPosition = GUILayout.BeginScrollView(_scrollPosition,
                GUILayout.Width(GUI.skin.button.fixedWidth + 20), GUILayout.Height(Screen.height));
            ...
            if (GUILayout.Button("Add Tap Recognizer"))
            {
                ...
                recognizer.gestureRecognizedEvent += (r) => { Debug.Log("tap recognizer fired: " + r); };
            ...
            if (GUILayout.Button("Add Long Press Recognizer"))
            {
                ...
                recognizer.gestureRecognizedEvent += (r) => { Debug.Log("long press recognizer fired: " + r); };
                recognizer.gestureCompleteEvent += (r) => { Debug.Log("long press recognizer finished: " + r); };
                TouchKit.addGestureRecognizer(recognizer);
            }
            ...
            if (GUILayout.Button("Add Pan Recognizer"))
            {
                ...
                recognizer.gestureRecognizedEvent += (r) =>
                {
                    Camera.main.transform.position -=
                        new Vector3(recognizer.deltaTranslation.x, recognizer.deltaTranslation.y) / 100;
                    Debug.Log("pan recognizer fired: " + r);
                };

                // continuous gestures have a complete event so that we know when they are done recognizing
                recognizer.gestureCompleteEvent += r => { Debug.Log("pan gesture complete"); };
                TouchKit.addGestureRecognizer(recognizer);
            }
            ...
            if (GUILayout.Button("Add TouchPad Recognizer"))
            {
                ...
                // continuous gestures have a complete event so that we know when they are done recognizing
                recognizer.gestureCompleteEvent += r => { Debug.Log("touchpad gesture complete"); };
                TouchKit.addGestureRecognizer(recognizer);
            }
            ...
            if (GUILayout.Button("Add Top-Right Swipe Recognizer"))
            {
                ...
                recognizer.addAngleRecogizedEvents(
                    (TKAngleSwipeRecognizer r) => { Debug.Log("Top-Right angle swipe fired " + r); }, new Vector2(1, 1),
                    45);
            ...
            if (GUILayout.Button("Add Button Recognizer"))
            {
                ...
                recognizer.zIndex = 1;
                recognizer.onSelectedEvent += (r) => { Debug.Log("button recognizer selected: " + r); };
                recognizer.onDeselectedEvent += (r) => { Debug.Log("button recognizer deselected: " + r); };
                recognizer.onTouchUpInsideEvent += (r) => { Debug.Log("button recognizer touch up inside: " + r); };
                TouchKit.addGestureRecognizer(recognizer);
            }
            ...
            if (GUILayout.Button("Add Any Touch Recognizer"))
            {
                ...
                recognizer.zIndex = 1;
                recognizer.onEnteredEvent += (r) => { Debug.Log("any touch entered: " + r); };
                recognizer.onExitedEvent += (r) => { Debug.Log("any touch exited: " + r); };
                TouchKit.addGestureRecognizer(recognizer);
            }
            ...
            if (GUILayout.Button("Add Curve Recognizer"))
            {
                ...
                recognizer.gestureCompleteEvent += (r) => { Debug.Log("curve completed."); };
