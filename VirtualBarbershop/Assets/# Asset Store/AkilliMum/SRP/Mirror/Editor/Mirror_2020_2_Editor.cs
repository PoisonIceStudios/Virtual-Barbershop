...
namespace AkilliMum.SRP.Mirror
{
    internal class Mirror_2020_2_Editor : BaseShaderGUI
    {
        ...
        // private SavedBool m_DetailInputsFoldout; // SavedBool è internal in Unity, non usato su Unity 6+
        ...
        public override void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            // m_DetailInputsFoldout = new SavedBool($"{headerStateKey}.DetailInputsFoldout", true); // Non supportato su Unity 6+
        }
#endif
        ...
        {
            // SavedBool non supportato su Unity 6+, commentato
