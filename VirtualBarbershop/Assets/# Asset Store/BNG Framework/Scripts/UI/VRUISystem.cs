    ...
    public class VRUISystem : BaseInputModule {
        ...
        void init() {
            if(cameraCaster == null) {
                ...
                // stereoTargetEye not supported in URP — XR system handles stereo rendering
        ...
        public override void Process() {
            ...
            // Handle Hover
            GameObject previousPointerOver = EventData.pointerEnter;
            HandlePointerExitAndEnter(EventData, EventData.pointerCurrentRaycast.gameObject);

            if (previousPointerOver != null && previousPointerOver != EventData.pointerEnter)
            {
                ResetButtonState();
            }
        ...
        public virtual void PressDown()
        {
            ...
            // Check if the pressing object is a Toggle
            Toggle toggle = PressingObject != null ? PressingObject.GetComponent<Toggle>() : null;
        ...
        public virtual void Press()
        {
            ...
            // Check if the pointer is still on the initial press object
            if (EventData.pointerCurrentRaycast.gameObject == _initialPressObject)
            {
                // Set Press Objects and Events
