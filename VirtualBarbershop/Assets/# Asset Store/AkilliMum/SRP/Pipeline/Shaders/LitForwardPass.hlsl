...
#endif
#if defined (_AKMU_SHADOW_RECEIVER)
#include "../../ShadowReceiver/Shader/ShadowDefinitions.hlsl"
#endif
...
#else
	float2  dynamicLightmapUV       : TEXCOORD9; // for uv2 usage
#endif
...
//#endif
    ...
    float4 probeOcclusion : TEXCOORD21;
#endif
...
#else
    surfaceData.albedo *= _Brightness; //car paint uses this by its own func!
#endif
...
#ifdef _AKMU_SHADOW_RECEIVER
	shadowReceiver(input.uv, input.positionWS, inputData, surfaceData, outColor);
	
    return; //!!!!!!!!!!!!!!!!!!!
#endif  //_AKMU_SHADOW_RECEIVER
	
	InitializeBakedGIData(input, inputData);
	
    half4 color = UniversalFragmentPBR(inputData, surfaceData, input.uv, input.uv_1, input.uv_2, input.uv_3);
...
//global end!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#if !defined _AKMU_GEOM_VOXEL && !defined _AKMU_GEOM_EXTRUDE //they uses their own appends
	//set new output and restart
	[unroll(3)]
	for (int i = 0; i < 3; ++i)
	{
