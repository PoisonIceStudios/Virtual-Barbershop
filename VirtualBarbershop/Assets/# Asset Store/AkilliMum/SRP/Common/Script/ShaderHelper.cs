...
namespace AkilliMum
{
    ...
    public static class ShaderHelper
    {
        ...
        {
            int stride = GetStride<T>();
            bool createNewBuffer = buffer == null || !buffer.IsValid() || buffer.count != data.Count ||
        ...
        public static void CreateArgsBuffer(ref ComputeBuffer argsBuffer, Mesh mesh, int numInstances)
        {
            ...
            bool createNewBuffer = argsBuffer == null || !argsBuffer.IsValid() || argsBuffer.count != numArgs ||
