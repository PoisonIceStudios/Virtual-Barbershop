...
namespace AkilliMum
{
    public static class ShaderIDs
    {
        ...
        public static int _OpaqueTextureCustomPass = Shader.PropertyToID("_OpaqueTextureCustomPass");
        public static int _AlphaTextureCustomPass = Shader.PropertyToID("_AlphaTextureCustomPass");
    }
}