...
namespace AkilliMum.SRP.Mirror
{
    ...
    public class MirrorManagerEditor : Editor
    {
        ...
        SerializedProperty CameraToDraw;
        SerializedProperty ReflectiveObjects;
        SerializedProperty ForceSceneView;
        ...
        void OnEnable()
        {
            ...
            CameraToDraw = serializedObject.FindProperty("CameraToDraw");
            ReflectiveObjects = serializedObject.FindProperty("ReflectiveObjects");
            ForceSceneView = serializedObject.FindProperty("ForceSceneView");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(CameraToDraw, new GUIContent { text = "Drawing Camera" });
            ...
            EditorGUILayout.PropertyField(ForceSceneView);
