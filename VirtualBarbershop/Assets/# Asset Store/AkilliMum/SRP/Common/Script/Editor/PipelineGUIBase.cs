...
#pragma warning restore CS0414
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            MenuGeneral = EditorGUILayout.BeginFoldoutHeaderGroup(MenuGeneral, new GUIContent { text = "General" });

            if (MenuGeneral)
            {
                MaterialProperty _Brightness = ShaderGUI.FindProperty("_Brightness", properties);
                materialEditorIn.ShaderProperty(_Brightness, "Color Brightness");

                MaterialProperty _CustomBrightnessIntensity = ShaderGUI.FindProperty("_CustomBrightnessIntensity", properties);
                materialEditorIn.ShaderProperty(_CustomBrightnessIntensity, "Reflection Brightness");

                MaterialProperty _FresnelIntensity = ShaderGUI.FindProperty("_FresnelIntensity", properties);
                materialEditorIn.ShaderProperty(_FresnelIntensity, "Fresnel Intensity");
                ...
                //    materialEditorIn.ShaderProperty(_EmissionUV, "Emission UV");
                //}
