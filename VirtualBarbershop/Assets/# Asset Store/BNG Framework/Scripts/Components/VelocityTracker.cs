...
namespace BNG {
    ...
    public class VelocityTracker : MonoBehaviour {
        ...
        public virtual void UpdateVelocity() {
            ...
            // Usa fixedDeltaTime (non deltaTime) perche questo gira in FixedUpdate.
            // Su VR i due valori divergono (90Hz render vs 50Hz physics) causando
            // velocita calcolate errate e jitter durante il grab.
        ...
        public virtual void UpdateAngularVelocity() {
            ...
            // Stesso fix: fixedDeltaTime invece di deltaTime in FixedUpdate
            _angularVelocity = axis * angle * (1.0f / Time.fixedDeltaTime);
