...
namespace AkilliMum.Touches
{
    ...
    public partial class TouchKit
    {
        ...
        private bool shouldProcessMouseInput()
        {
            ...
            if (simulateMultitouch && (_hasActiveSimulatedMultitouch || Input.GetKey(KeyCode.LeftAlt) ||
        ...
        private void OnDrawGizmos()
        {
            ...
            if (drawTouches)
            {
                ...
                foreach (TKTouch touch in _touchCache)
                {
                    ...
                    {
                        var touchPos = Camera.main.ScreenToWorldPoint(new Vector3(touch.position.x, touch.position.y,
                ...
                if (_simulatedMultitouchStartPosition.HasValue && !_hasActiveSimulatedTouch)
                {
                    ...
                    var simulatedPos = Camera.main.ScreenToWorldPoint(new Vector3(_simulatedMousePosition.x,
                        _simulatedMousePosition.y, Camera.main.farClipPlane));
