...
namespace ECE
{
  ...
  public class EasyColliderWindow : EditorWindow
  {
    ...
    private void PrefabStageClosing(UnityEditor.SceneManagement.PrefabStage stage)
    {
      PrefabStageClean(stage);
      Undo.ClearAll();
    }

    private void PrefabStageOpened(UnityEditor.SceneManagement.PrefabStage stage)
    {
    ...
    private void PrefabStageClean(UnityEditor.SceneManagement.PrefabStage stage)
    {
