...
#include "../../Pipeline/Core/ShaderLibrary/API/D3D11.hlsl"
#elif defined(SHADER_API_METAL)
#include "../../Pipeline/Core/ShaderLibrary/API/Metal.hlsl"
#elif defined(SHADER_API_VULKAN)
#include "../../Pipeline/Core/ShaderLibrary/API/Vulkan.hlsl"
#elif defined(SHADER_API_SWITCH)
#include "../../Pipeline/Core/ShaderLibrary/API/Switch.hlsl"
#elif defined(SHADER_API_GLCORE)
#include "../../Pipeline/Core/ShaderLibrary/API/GLCore.hlsl"
#elif defined(SHADER_API_GLES3)
#include "../../Pipeline/Core/ShaderLibrary/API/GLES3.hlsl"
#elif defined(SHADER_API_WEBGPU)
#include "../../Pipeline/Core/ShaderLibrary/API/WebGPU.hlsl"
#else
#error unsupported shader api
#endif
#include "../../Pipeline/Core/ShaderLibrary/API/Validate.hlsl"

#include "../../Pipeline/Core/ShaderLibrary/Macros.hlsl"
#include "../../Pipeline/Core/ShaderLibrary/Random.hlsl"
...
#include "../../Pipeline/Core/ShaderLibrary/CommonDeprecated.hlsl"
