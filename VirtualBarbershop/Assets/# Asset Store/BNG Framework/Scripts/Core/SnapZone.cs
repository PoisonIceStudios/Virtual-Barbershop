...
namespace BNG {
    public class SnapZone : MonoBehaviour {
        ...
        /* Per evitare che si esegua il suono all'avvio. */
        bool firstTime;
        bool firstTime_Release;
      ...
      //  public float ScaleItem = 1f;
       // private float _scaleTo;
        ...
        void Start() {
            ...
            /* Inizializzo variabili per evitare che si eseguano i suoni al primo avvio */
            firstTime = true;
            firstTime_Release = true;
        ...
        public void ReleaseAll() {
          ...
          //  HeldItem.ResetScale();
            ...
            // Play Unsnap sound  && (firstTime)
            if ((HeldItem != null) && !firstTime_Release){
                if (SoundOnSnap) {
            ...
            if (firstTime_Release)
                firstTime_Release = false;
